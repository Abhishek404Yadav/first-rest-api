...
.get((req, res) => {
  ...
  if (!result)
    res
      .status(404)
      .send(`Task with folloing id: ${Passed_id} is not availabel`);
...
.put((req, res) => {
    ...
    res
    .status(404)
    .send(`Task with folloing id: ${Passed_id} is no availabel`);
  ...
  .delete((req, res) => {
    ...
    res
      .status(200)
      .send(`course with id:${Passed_id} has been deleted successfully`);
  });
